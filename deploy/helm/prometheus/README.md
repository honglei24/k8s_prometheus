...
```console
$ helm install <helm-repo>/prometheus
```
...
```console
$ helm install --name my-release <helm-repo>/prometheus
```
...
```console
$ helm install <helm-repo>/prometheus --name my-release \
...
```console
$ helm install <helm-repo>/prometheus --name my-release -f values.yaml
```
...
```console
$ helm install <helm-repo>/prometheus --name my-release -f values.yaml -f service1-alert.yaml -f service2-alert.yaml
```
